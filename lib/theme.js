...
export const COLOR = {
  bg: 0x000000,
  // War 0x14141a (dann 0x24242e als Zwischenschritt), beides auf dem
  // echten AMOLED laut Jan weiterhin kaum sichtbar. Jetzt exakt die Werte
  // aus dem SmartLock/Nuki-Projekt uebernommen, dort auf dem selben
  // Geraet als gut sichtbar bestaetigt.
  card: 0x3a3a3a,
  cardPress: 0x555555,
  text: 0xffffff,
  textDim: 0x8e8e98,
