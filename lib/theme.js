...
export const COLOR = {
  bg: 0x000000,
  // War 0x14141a - auf AMOLED gegen echtes Schwarz kaum von der Karte zu
  // unterscheiden (Jans Foto vom Home-Screen: Karten/Buttons praktisch
  // unsichtbar). Deutlich angehoben + eigener Border fuer klare Kontur.
  card: 0x24242e,
  cardBorder: 0x38383f,
  text: 0xffffff,
  textDim: 0x8e8e98,
